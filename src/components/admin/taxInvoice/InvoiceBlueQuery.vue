                ...
                <div class="card-content-padded">
                  ...
                  <div class="lc-row lc-space5">
                    <div
                      ...
                      :key="index"
                      class="card card-shadow mt15 lc-col-12 lc-col-xs12"
                    >
                      <div class="card-body">
                        <div class="card-content-padded">
                          <div class="lc-row lc-space16">
                            <div class="lc-col-12 lc-col-xs6">
                              <div
                                class="flex flex-content-start flex-items-center"
                              >
                                <label class="nowrap">销方名称:</label>
                                <div class="flex-flex-auto">
                                  <span>{{ item.xsfmc || '-' }}</span>
                                </div>
                              </div>
                            </div>
                            <div class="lc-col-12 lc-col-xs6">
                            ...
                            <div class="lc-col-12 lc-col-xs6">
                              <div
                                class="flex flex-content-start flex-items-center"
                              >
                                <label class="nowrap">购方单位:</label>
                                <div class="flex-flex-auto">
                                  <span>{{ item.gmfmc || '-' }}</span>
                                </div>
                              </div>
                            </div>
                            <div class="lc-col-12 lc-col-xs6">
                              <div
                                class="flex flex-content-start flex-items-center"
                              >
                                <label class="nowrap">购方单位企业税号:</label>
                                <div class="flex-flex-auto">
                                  <span>{{ item.gmfnsrsbh || '-' }}</span>
                                </div>
                              </div>
                            </div>
                            <div class="lc-col-12 lc-col-xs6">
                              <div
                                class="flex flex-content-start flex-items-center"
                              >
                                <label class="nowrap">开票日期:</label>
                                <div class="flex-flex-auto">
                                  <span>{{ formatDateTime(item.kprq) }}</span>
                                </div>
                              </div>
                            </div>
                            <div class="lc-col-12 lc-col-xs6">
                              <div
                                class="flex flex-content-start flex-items-center"
                              >
                                <label class="nowrap">合计金额（含税）:</label>
                                <div class="flex-flex-auto">
                                  <span
                                    >¥{{
                                      Number(item.hjje || 0).toFixed(2)
                                    }}</span
                                  >
                                </div>
                              </div>
                            ...
                            <div class="lc-col-12 lc-col-xs6">
                              <div
                                class="flex flex-content-start flex-items-center"
                              >
                                <label class="nowrap">合计税额:</label>
                                <div class="flex-flex-auto">
                                  <span
                                    >¥{{
                                      Number(item.hjse || 0).toFixed(2)
                                    }}</span
                                  >
                                </div>
                              </div>
                            ...
                            <div class="lc-col-12 lc-col-xs6">
                              <div
                                class="flex flex-content-start flex-items-center"
                              >
                                <label class="nowrap">价税合计:</label>
                                <div class="flex-flex-auto">
                                  <span
                                    >¥{{
                                      Number(item.jshj || 0).toFixed(2)
                                    }}</span
                                  >
                                </div>
                              </div>
