        ...
        <div class="viewport-view-body flex flex-column">
          ...
          <div class="panel pl15 pr15 pt10" v-if="selectOrgConfig.type === 2">
            <div class="search-bar flex flex-content-start flex-items-center flex-wrap">
              ...
              <div class="search-bar-item">
                <el-input
                  v-model="searchParams.partycName"
                  size="small"
                  placeholder="丙方名称">
                </el-input>
              </div>
          ...
          <!--
            查合同 签署单
          -->
          <div class="panel pl15 pr15 pt10" v-if="selectOrgConfig.type === 22">
            <div class="search-bar flex flex-content-start flex-items-center flex-wrap">
              <div class="search-bar-item">
                <!-- 
                  合同id
...
export default {
  ...
  methods: {
    ...
    if(type === 2){
      this.cols = [
        { label: '协议ID', id: 'id', width: '130' },
        { label: '协议编码', id: 'contractNo', width: '130' },
        ...
        { label: '协议版号', id: 'versionNum', width: '130' },
        { label: '类型', id: 'versionNum', width: '130' , render: (row)=>{
          if(row.versionNum){
            return contractTypeName(row.versionNum);
          }
          } },
      ];
    }
    ...
    getData (args) {
      ...
      if (this.selectOrgConfig.type === 2) {
        services = this.CFG.services.ecContract.baseList;
      }
      /**
       * 查合同 签署单
       */
      if (this.selectOrgConfig.type === 22) {
        services = this.CFG.services.ecContract.baseApplyList;
      }
      /**
       * 查自然人
       */
