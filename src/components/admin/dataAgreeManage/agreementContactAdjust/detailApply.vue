                ...
                <div class="lc-row lc-space16">
                  <div class="lc-col-12 lc-col-xs6">
                    <div class="flex flex-content-start flex-items-center">
                      ...
                      <div class="flex-flex-auto">
                        <el-radio @input="$forceUpdate()" disabled v-model="orderData.effectType" label="1" size="small">立即生效</el-radio>
                        <el-radio @input="$forceUpdate()" disabled v-model="orderData.effectType" label="2" size="small">延迟生效</el-radio>
                      </div>
                    </div>
                  </div>
...
export default {
  ...
  methods: {
    ...
    getData (data) {
      let service = null
      service = this.CFG.services.ecRefApply.view
