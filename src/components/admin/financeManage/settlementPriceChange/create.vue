    ...
    <div class="viewport-view">
      <div class="viewport-view-body flex flex-column">
        <div class="panel-content-padded">
          <h2 class="pl15 pb10">结算价格修改规则修改单</h2>
          <div class="pl15 pr15">
            <div class="card card-shadow mt10">
              <div class="card-body">
                <div class="card-header">
                  <strong>结算价格修改规则查询</strong>
                </div>
                      ...
                      <div class="card card-shadow mt15 lc-col-12 lc-col-xs12" v-for="item in list"
                        ...
                        <div class="card-body">
                          ...
                          <div class="card-footer">
                            <span class="black">是否为此结算价格规则进行修改:</span>
...
export default {
  ...
  methods: {
   ...
   /**
     ...
     */
    queryOrg () {
      // if (!this.search.relContractId && !this.search.partyaName && !this.search.partybName && !this.search.contractId && !this.search.versionNum && !this.search.partybRemitterName && !this.search.salesmanName) {
