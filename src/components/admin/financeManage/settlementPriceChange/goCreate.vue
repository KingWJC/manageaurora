                ...
                <div class="lc-row lc-space16">
                  ...
                  <div class="lc-col-12 lc-col-xs6">
                    <div class="flex flex-content-start flex-items-center">
                      ...
                      <div class="flex-flex-auto">
                        <el-radio-group v-model="orderData.calcWay" disabled @input="changeCalcWay">
                          <el-radio
                            :label="0"
...
export default {
  ...
  created () {
     ...
     * 加载单据数据
     */
    this.getData({ id: this.params.orgId })
  ...
  methods: {
    ...
    getData (data) {
      let service = null
      service = this.CFG.services.settlementNew.queryResult
      this.API.send(service, data, function (res) {
        this.orderData = {...res.serviceResult};
        this.orderData.resultId = this.orderData.id;
        delete this.orderData.id;
        this.orderData.partyA = {};
        this.orderData.partyB = {};
        // 如果是选择的合同
        // 组装结算方数据进行显示
        // 结算方不固定
    ...
    saveOrder () {
      ...
      this.goSubMit(this.CFG.services.settlementNew.upsertModify, this.orderData);
    },
    /**
     * 提交数据
     */
