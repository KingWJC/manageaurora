                  ...
                  <template v-if="orderData.partyB.partySubjectType === '0'">
                    ...
                    <div class="lc-col-12 lc-col-xs6">
                      <div class="flex flex-content-start flex-items-center">
                        ...
                        <div class="flex flex-flex-auto">
                          <el-select v-model="orderData.partyB.salesmanLevel" @input="$forceUpdate()" clearable class="full-width" size="small" placeholder="业务员级别">
                    ...
                    <div class="lc-col-12 lc-col-xs6">
                      <div class="flex flex-content-start flex-items-center">
                        ...
                        <div class="flex-flex-auto">
                          <treeselect :options="businessOrganizationList" multiple v-model="orderData.partyB.businessOrgIdList" :appendToBody="true" placeholder="业务组织"></treeselect>
                        </div>
                      </div>
                    </div>
                  </template>
                ...
                <div class="lc-row lc-space16">
                  ...
                  <div class="lc-col-12 lc-col-xs6">
                    <div class="flex flex-content-start flex-items-center">
                      ...
                      <div class="flex-flex-auto">
                        <el-radio-group v-model="orderData.calcWay" @input="changeCalcWay">
                          <el-radio
                            :label="0"
...
export default {
  ...
  methods: {
    ...
    saveOrder () {
       ...
       * 请选择结算业务员类型
       */
      if(this.orderData.isBaseContract === '2' && this.orderData.partyB.partySubjectType === '0' && !this.orderData.partyB.salesmanLevel){
        this.$toast({text: '请选择结算业务员类型'});
        return false;
      }
      /**
       * 请选择指定类型
      ...
      if(this.orderData.isBaseContract === '2'){
        ...
        // 如果是0 业务员时， 旧数据可能会返回 partyId可能会返回 以逗号分隔的多个 id 组成的字符串 此时要转成数组
        if(this.orderData.partyB.partySubjectType === '0' && this.orderData.partyB.partyId){
          this.orderData.partyB.partyId = this.orderData.partyB.partyId.split(",");
        }
      ...
      this.goSubMit(this.CFG.services.settlementNew.upsertAdjust, this.orderData);
    },
    /**
     * 提交数据
     */
