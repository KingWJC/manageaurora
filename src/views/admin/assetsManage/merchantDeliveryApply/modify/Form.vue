 ...
 * @FilePath: /manageaurora/src/views/admin/assetsManage/merchantDeliveryApply/modify/Form.vue
...
<script>
// 渲染组件 FormView
import FormView from '@/components/admin/assetsManage/merchantDeliveryApply/Form';
// 权限 mixins
