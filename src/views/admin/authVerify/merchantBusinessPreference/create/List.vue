 ...
 * @FilePath: /manageaurora/src/views/admin/authVerify/merchantBusinessPreference/create/List.vue
...
<script>
// 渲染组件 ListView
import ListView from '@/components/admin/authVerify/merchantBusinessPreference/List';
// 权限 mixins
