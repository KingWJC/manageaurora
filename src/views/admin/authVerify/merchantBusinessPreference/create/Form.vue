 ...
 * @FilePath: /manageaurora/src/views/admin/authVerify/merchantBusinessPreference/create/Form.vue
...
<script>
// 渲染组件 FormView
import FormView from '@/components/admin/authVerify/merchantBusinessPreference/Form';
// 权限 mixins
