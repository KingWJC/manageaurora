...
function h (e, t) {
  t = t || 0;
  var n, r = (e = e || '').length % 16, a = e.length - r, o = [0, t], i = [0, t], h = [0, 0], v = [0, 0],
    p = [2277735313, 289559509], m = [1291169091, 658871167];
          ...
          r((function () {
            return new Promise((function (e) {
              ...
              o(c, (function () {
                ...
                var a = i + Date.now() - t;
                if (!n[0]) return e({error: w(n[1]), duration: a});
...
function D (e, t) {
  for (var n = 0, r = t.split(';'); n < r.length; n++) {
    var a = r[n], o = /^\s*([\w-]+)\s*:\s*(.+?)(\s*!([\w-]+))?\s*$/.exec(a);
    if (o) {
      var i = o[1], c = o[2], u = o[4];
      e.setProperty(i, c, u || '');
    }
  }
}
...
var te = {
  fonts: function () {
    return E((function (e, t) {
      ...
      var a = n.createElement('div'), o = {}, i = {}, c = function (e) {
      ...
      r.appendChild(a);
      for (var l = 0; l < L.length; l++) o[L[l]] = u[l].offsetWidth, i[L[l]] = u[l].offsetHeight;
      return I.filter((function (e) {
        return t = s[e], L.some((function (e, n) {
    ...
    return t(this, void 0, void 0, (function () {
      ...
      return n(this, (function (n) {
        switch (n.label) {
          case 0:
            return x() || _() ? (e = Object.keys(q), [4, H((o = []).concat.apply(o, e.map((function (e) {
              return q[e];
            }))))]) : [2, void 0];
          case 1:
    ...
    return function (e, t) {
      ...
      return E((function (n, a) {
        var o = a.document, i = o.body, c = i.style;
      ...
      for (var n = {}, r = {}, a = 0, o = Object.keys(ee); a < o.length; a++) {
        var i = o[a], c = ee[i], u = c[0], s = void 0 === u ? {} : u, l = c[1],
          d = void 0 === l ? 'mmMwWLliI0fiflO&1' : l, f = e.createElement('span');
    ...
    var n = new t(1, 5e3, 44100), r = n.createOscillator();
    ...
    var o = function (e) {
      var t = 3, n = 500, r = 500, a = 5e3, o = function () {
      };
    ...
    }(n), i = o[0], c = o[1], u = i.then((function (e) {
      return function (e) {
    ...
    if (void 0 !== r && n.push([r]), Array.isArray(t.languages)) A() && g([!('MediaSettingsRange' in (e = window)), 'RTCEncodedAudioFrame' in e, '' + e.Intl == '[object Intl]', '' + e.Reflect == '[object Reflect]']) >= 3 || n.push(t.languages); else if ('string' == typeof t.languages) {
      var a = t.languages;
      a && n.push(a.split(','));
    }
    return n;
    ...
    var r,
      a = (r = (new Date).getFullYear(), -Math.max(p(new Date(r, 0, 1).getTimezoneOffset()), p(new Date(r, 6, 1).getTimezoneOffset())));
    ...
    }(t, n) ? {winding: B(n), geometry: F(t, n), text: O(t, n)} : {winding: !1, geometry: '', text: ''};
    ...
    return {maxTouchPoints: n, touchEvent: e, touchStart: 'ontouchstart' in window};
  }, vendor: function () {
    ...
    var e, t = Z.acos || Q, n = Z.acosh || Q, r = Z.asin || Q, a = Z.asinh || Q, o = Z.atanh || Q, i = Z.atan || Q,
      c = Z.sin || Q, u = Z.sinh || Q, s = Z.cos || Q, l = Z.cosh || Q, d = Z.tan || Q, f = Z.tanh || Q, h = Z.exp || Q,
      v = Z.expm1 || Q, p = Z.log1p || Q;
    return {
...
function ne (e) {
  ...
  return {score: t, comment: '$ if upgrade to Pro: https://fpjs.dev/pro'.replace(/\$/g, '' + n)};
}
...
function ae (e) {
  return h(function (e) {
    for (var t = '', n = 0, r = Object.keys(e).sort(); n < r.length; n++) {
      var a = r[n], o = e[a], i = o.error ? 'error' : JSON.stringify(o.value);
      t += (t ? '|' : '') + a.replace(/([:|\\])/g, '\\$1') + ':' + i;
    }
    return t;
  }(e));
          ...
          switch (n.label) {
            ...
            case 1:
              return i = n.sent(), c = function (e) {
                ...
                return {
                  get visitorId () {
                    return void 0 === t && (t = ae(this.components)), t;
                  }, set visitorId (e) {
                    t = e;
                  }, confidence: ne(e), components: e, version: '3.3.3'
                };
...
function ce (e) {
  var r = void 0 === e ? {} : e, a = r.delayFallback, o = r.debug;
...
var ue = {load: ce, hashComponents: ae, componentsToDebugString: re}, se = h;
export {
