<template>
  <div class="viewport-fixed">
    <div class="viewport-view">
      <div class="viewport-view-body login-bg flex flex-column flex-content-center">
        <div class="login-box">
...
export default {
  ...
  methods: {
    ...
    sendSms: function () {
      ...
      this.API.send(this.CFG.services.common.sendSms4login, {phone: this.formdata.phone}, function (res) {
          if (res.opFlag) {
            times = 60
            this.isSmsLocked = true
            this.startTimer()
